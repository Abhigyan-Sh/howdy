...
const Button = ({ text, type, className, onClick, icon: Icon, iconProps }) => {
  const buttonStyles = {
    ...
    primary: "focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900", 
    secondary: "focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:focus:ring-yellow-900", 
    ...
    danger: "focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900", 
  ...
  return (
    <button 
      ...
      onClick={onClick}>
        <div className={`flex flex-row items-center justify-between ${text && Icon && "gap-2"}`}>
